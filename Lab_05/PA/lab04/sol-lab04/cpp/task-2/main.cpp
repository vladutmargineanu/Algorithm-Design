...
class Task {
 ...
 private:
    ...
    int bool_expression() {
        ...
        //      La PODM avem o dinamica de forma do[i][j] = ..., ceea ce ar avea foarte mult sens si aici,
        ...
        // dp are dimensiunile n x n x 2 (daca nu va place acest oneliner, puteti sa alocati fiecare dimensiune pas cu pas)
                ...
                for (int k = i + 1; k < j; ++k) {       // k este OPERATOR intre i si j
                    ...
                    for (int lv = 0; lv <= 1; ++lv) {
                        for (int rv = 0; rv <= 1; ++rv) {
                            ...
                            // Trebuie sa il adaugam la rezultatul pentru [i,j] si valoare nv
